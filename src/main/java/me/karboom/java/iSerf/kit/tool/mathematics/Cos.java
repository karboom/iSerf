 ...
 * 余弦运算(弧度制)
 */
public class Cos implements FunctionWrapper<Cos.Parameter> {

    public static String description = "计算数字的余弦值 (弧度制)";

    public static class Parameter {
        @JsonPropertyDescription("弧度值")
    ...
    public CallResult run(Context ctx, Parameter params) {
        var result = FastMath.cos(params.number);
