 ...
 * 反正弦运算(返回弧度)
 */
public class Asin implements FunctionWrapper<Asin.Parameter> {

    public static String description = "计算数字的反正弦值 (返回弧度)";

    public static class Parameter {
        @JsonPropertyDescription("正弦值 (-1 到 1 之间)")
    ...
    public CallResult run(Context ctx, Parameter params) {
        var result = FastMath.asin(params.number);
