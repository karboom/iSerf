...
public interface ITeamLifecycle {
     ...
     * @return Team 实例
     */
    Team createTeam(Context ctx, ObjectNode params);
     ...
     * @return 匹配的 Team 列表
     */
    List<Team> listTeam(Context ctx, ObjectNode params);
     ...
     */
    Team removeTeam(Context ctx, ObjectNode params);
     ...
     */
    Team editTeam(Context ctx, ObjectNode params);
     ...
     */
    Team detailTeam(Context ctx, ObjectNode params);
